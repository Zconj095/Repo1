...
#---------------BEGIN FILE: C:\Users\Zack\Unity Versions\6000.0.48f1\6000.0.48f1\Editor\Data\Tools\FBXMaxExport.ms---------------
...
openLog "!//UNITY_TEMP//!/3dsMax.log" mode:"w"
print "Start of log file."; flushLog();
while true do
(	
	if ( fileExists "!//UNITY_TEMP//!/MaxCommandPipe" ) then
	(
		exportNormals = false;
		...
		waitpipe = (openFile "!//UNITY_TEMP//!/MaxCommandPipe" mode:"r");
		...
		(
			...
			(
				...
				deleteFile "!//UNITY_TEMP//!/MaxCommandPipe";
...
#---------------END FILE: C:\Users\Zack\Unity Versions\6000.0.48f1\6000.0.48f1\Editor\Data\Tools\FBXMaxExport.ms---------------
